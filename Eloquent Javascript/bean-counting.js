/**
  ...
  *  function.
  *
  *  This exercise is from Chapter 3 of Eloquent JavaScript.
  *
  */

var countChars = function(str, ch) {
    var totalChars = 0;
...
console.log("countBs(\"aBcdf\") = %d", countBs("aBcdf"));
console.log("countBs(\"acd\") = %d", countBs("acd"));
console.log("countBs(\"B\") = %d", countBs("B"));
console.log("countBs(\"aBbBf\") = %d", countBs("aBbBf"));
